...
kernel_plain_sha256_granted if {
    ...
    tpm2evlog.events[i].Digests[j].Digest == trim_left(refstate.kernel_plain_sha256, "0x")
}
...
initrd_plain_sha256_granted if {
    ...
    tpm2evlog.events[i].PCRIndex == 9
    tpm2evlog.events[i].Digests[j].AlgorithmId == "sha256"
    tpm2evlog.events[i].Digests[j].Digest == trim_left(refstate.initrd_plain_sha256, "0x")
}
...
grub_authcode_sha256_granted if {
    ...
    tpm2evlog.events[i].Digests[j].AlgorithmId == "sha256"
    tpm2evlog.events[i].Digests[j].Digest == trim_left(refstate.grub_authcode_sha256, "0x")
}
...
shim_authcode_sha256_granted if {
    ...
    tpm2evlog.events[i].PCRIndex == 4
    tpm2evlog.events[i].Digests[j].AlgorithmId == "sha256"
    tpm2evlog.events[i].Digests[j].Digest == trim_left(refstate.shim_authcode_sha256, "0x")
}
...
kernel_authcode_sha256_granted if {
    ...
    tpm2evlog.events[i].PCRIndex == 4
    tpm2evlog.events[i].Digests[j].AlgorithmId == "sha256"
    tpm2evlog.events[i].Digests[j].Digest == trim_left(refstate.kernel_authcode_sha256,"0x")
}
